...
args.MODEL_NAME = "/home/ros/share_dir/gitrepos/llama.onnx/HF-MODEL/rwkv-4-pile-430m/RWKV-4-Pile-430M-20220808-8066"
args.n_layer = 24
args.n_embd = 1024
...
class RWKV_RNN(torch.jit.ScriptModule):
    ...
    def __init__(self, args):
        ...
        self.encoder = Encoder(
            self.w.emb.weight, self.w.blocks[0].ln0.weight, self.w.blocks[0].ln0.bias
        )
        self.encoder.eval()

        self.decoder = Decoder(
            self.w.head.weight, self.w.ln_out.weight, self.w.ln_out.bias
        )
        self.decoder.eval()
