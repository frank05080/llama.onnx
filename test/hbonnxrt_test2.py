...
input_bin_file = "/home/ros/share_dir/gitrepos/llama.onnx/tools/inputs5/head_input.bin"
data = np.fromfile(input_bin_file, dtype=np.float32)
print(data)
print(data.shape)
# 加载模型文件
sess = HB_ONNXRuntime(model_file = "/home/ros/share_dir/gitrepos/llama.onnx/bpu_convert_yaml/model_convert_output_rwkv_head/model_convert_output/rwkv_head_calibrated_model.onnx")
# 获取模型输入&输出节点信息
